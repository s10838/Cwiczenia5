...
namespace Cwiczenia5.Context;

public partial class S10838Context : DbContext
{
    public S10838Context()
    {
    }

    public S10838Context(DbContextOptions<S10838Context> options)
        : base(options)
    {
    }
